...
import { useUnifiedSaaSStore, type SaaSRole, type SaaSModule } from '@/stores/unifiedSaaSStore';
...
export const ROLE_CONNECTION_RULES: Record<SaaSRole, RoleConnection> = {
  ...
  boss_owner: {
    role: 'boss_owner',
    connectedRoles: [
      'ceo', 'vala_ai', 'server_manager', 'ai_api_manager', 'development_manager',
  ...
  ceo: {
    role: 'ceo',
    connectedRoles: ['boss_owner', 'analytics_manager', 'finance_manager', 'marketing_manager'],
    ...
    autoTriggers: [
      { event: 'quarterly_report_ready', targetRole: 'boss_owner', action: 'review' },
  ...
  vala_ai: {
    role: 'vala_ai',
    connectedRoles: ['boss_owner', 'ceo', 'analytics_manager', 'development_manager'],
    ...
    autoTriggers: [
      { event: 'pattern_detected', targetRole: 'boss_owner', action: 'notify' },
      { event: 'optimization_opportunity', targetRole: 'ceo', action: 'suggest' }
    ],
    permissions: {
      canViewAllData: true,
      canEditOwnData: true,
  ...
  server_manager: {
    role: 'server_manager',
    connectedRoles: ['boss_owner', 'deployment_manager', 'security_manager', 'ai_api_manager'],
    ...
    autoTriggers: [
      { event: 'server_overload', targetRole: 'boss_owner', action: 'alert' },
  ...
  marketing_manager: {
    ...
    connectedRoles: ['boss_owner', 'ceo', 'influencer_manager', 'marketplace_manager', 'analytics_manager'],
  ...
  lead_manager: {
    role: 'lead_manager',
    connectedRoles: ['marketing_manager', 'sales_manager', 'boss_owner'],
  ...
  sales_manager: {
    role: 'sales_manager',
    connectedRoles: ['lead_manager', 'finance_manager', 'reseller_manager', 'franchise_manager', 'boss_owner'],
  ...
  finance_manager: {
    ...
    connectedRoles: ['sales_manager', 'license_manager', 'boss_owner', 'ceo'],
    ...
    autoTriggers: [
      ...
      { event: 'revenue_report_ready', targetRole: 'ceo', action: 'review' }
    ],
    permissions: {
      canViewAllData: false,
      canEditOwnData: true,
  ...
  customer_support: {
    ...
    connectedRoles: ['license_manager', 'user_dashboard', 'analytics_manager', 'boss_owner'],
  ...
  franchise_manager: {
    ...
    connectedRoles: ['sales_manager', 'lead_manager', 'reseller_manager', 'boss_owner'],
  ...
  reseller_manager: {
    ...
    connectedRoles: ['sales_manager', 'lead_manager', 'franchise_manager', 'boss_owner'],
  ...
  influencer_manager: {
    ...
    connectedRoles: ['marketing_manager', 'lead_manager', 'boss_owner'],
  ...
  continent_admin: {
    ...
    connectedRoles: ['country_admin', 'boss_owner'],
    ...
    autoTriggers: [
      { event: 'regional_target_met', targetRole: 'boss_owner', action: 'report' },
  ...
  analytics_manager: {
    ...
    connectedRoles: ['boss_owner', 'ceo', 'all_managers'],
    ...
    pipelineStages: ['analytics'],
    autoTriggers: [
      { event: 'analytics_report_ready', targetRole: 'boss_owner', action: 'review' },
      { event: 'kpi_alert', targetRole: 'ceo', action: 'investigate' }
    ],
    permissions: {
      canViewAllData: true,
      canEditOwnData: true,
  ...
  // OTHER ROLES (simplified for brevity - would include all 37 roles)
  ai_api_manager: {
    role: 'ai_api_manager',
  ...
  // Add remaining roles following the same pattern...
  development_manager: {
  ...
  // Add all other roles with similar structure...
  product_manager: {
    role: 'product_manager',
    connectedRoles: ['development_manager', 'marketing_manager', 'demo_manager'],
    accessibleModules: ['product_manager', 'development_manager', 'marketing_manager', 'demo_manager'],
    dataAccess: {
      read: ['products', 'features', 'roadmap', 'feedback'],
      write: ['products', 'roadmap', 'features'],
      delete: ['deprecated_features']
    },
    pipelineStages: ['marketplace'],
    autoTriggers: [
      { event: 'product_launched', targetRole: 'marketing_manager', action: 'promote' },
      { event: 'feature_requested', targetRole: 'development_manager', action: 'develop' }
    ],
    permissions: {
      canViewAllData: false,
      canEditOwnData: true,
  ...
  demo_manager: {
    role: 'demo_manager',
    connectedRoles: ['product_manager', 'marketing_manager', 'sales_manager'],
    accessibleModules: ['demo_manager', 'product_manager', 'marketing_manager', 'sales_manager'],
    dataAccess: {
      read: ['demos', 'demo_requests', 'conversion_rates'],
      write: ['demos', 'demo_settings'],
      delete: ['old_demos']
    },
    pipelineStages: ['marketplace', 'lead'],
    autoTriggers: [
      { event: 'demo_requested', targetRole: 'sales_manager', action: 'follow_up' },
      { event: 'demo_completed', targetRole: 'marketing_manager', action: 'track_conversion' }
    ],
    permissions: {
      canViewAllData: false,
      canEditOwnData: true,
  ...
  // Add remaining roles (task_manager, promise_tracker, asset_manager, seo_manager, etc.)
  task_manager: {
    role: 'task_manager',
    connectedRoles: ['all_managers', 'boss_owner'],
    accessibleModules: ['task_manager'],
    dataAccess: {
      read: ['tasks', 'projects', 'assignments'],
      write: ['tasks', 'assignments'],
      delete: ['completed_tasks']
    },
    pipelineStages: [],
    autoTriggers: [
      { event: 'task_assigned', targetRole: 'user_dashboard', action: 'notify' },
      { event: 'task_completed', targetRole: 'boss_owner', action: 'track' }
    ],
    permissions: {
      canViewAllData: false,
      canEditOwnData: true,
  ...
  promise_tracker: {
    ...
    connectedRoles: ['boss_owner', 'ceo', 'all_managers'],
    accessibleModules: ['promise_tracker'],
    dataAccess: {
      read: ['promises', 'commitments', 'deadlines'],
      write: ['promises', 'deadlines'],
      delete: ['fulfilled_promises']
    },
    pipelineStages: [],
    autoTriggers: [
      { event: 'promise_made', targetRole: 'boss_owner', action: 'track' },
      { event: 'deadline_approaching', targetRole: 'task_manager', action: 'remind' }
    ],
    permissions: {
      canViewAllData: false,
      canEditOwnData: true,
  ...
  // Add remaining roles following the same pattern...
  asset_manager: { /* similar structure */ },
  seo_manager: { /* similar structure */ },
  legal_manager: { /* similar structure */ },
  developer_dashboard: { /* similar structure */ },
  pro_manager: { /* similar structure */ },
  security_manager: { /* similar structure */ },
  system_settings: { /* similar structure */ },
  marketplace_manager: { /* similar structure */ },
  demo_system_manager: { /* similar structure */ },
  deployment_manager: { /* similar structure */ },
  notification_manager: { /* similar structure */ },
  integration_manager: { /* similar structure */ },
  audit_logs_manager: { /* similar structure */ },
  marketplace_core: { /* similar structure */ },
};
...
export const useRoleConnections = () => {
  ...
  const { activeRole, currentUser } = useUnifiedSaaSStore.getState();
