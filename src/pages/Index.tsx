...
const categories = [
  ...
  "Yoga", "Tattoo", "Clinic", "Aquarium", "Pizzeria", "Coffee Shop", "Florist",
  "Pest Control", "Catering", "Ice Cream", "Martial Arts", "Gaming", "Escape Room",
  "Water Park", "Amusement Park", "Zoo", "Museum", "Art Gallery", "Antique",
  "Dry Cleaning", "Food Truck", "Swimming", "Bowling", "Trampoline", "Go-Kart"
];
